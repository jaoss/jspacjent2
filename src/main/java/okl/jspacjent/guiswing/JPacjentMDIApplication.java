...
public class JPacjentMDIApplication extends javax.swing.JFrame {
  ...
  // Fields
   ...
   /** Spring context for application */
  ...
  */
  ...
  protected final void createApplicationContext() {
  ...
  protected final void createUtilities() {     
    if ( util == null ) { 
      if (applicationContext != null ) {
        ...
        System.out.println(" ...Utilities not created");
      }      
    }
    else {
      System.out.println(" ...Utilities is already created");
    }
  }
  
  protected final void createDao() { 
    if ( dao == null ) { 
      if (applicationContext != null ) {
        ...
        System.out.println(" ...Dao not created");
      }
    }
    else {
      System.out.println(" ...Dao is arleady created");
    }
    
  }
  
  protected final void createLists() {
    // ...
  ...
  protected final void updateComponents() {
    if ( getDao() == null ) {
      ...
      toolLabel.setText("Po³¹czenie z baz¹ danych OK.");
    }
    // ...
    if ( isClient() ) {
  ...
  protected final void setUpLookAndFeel() throws Exception {    
    ...
    System.out.println(" ...Look and Feel set up");
  }
  
  /** Creates new form JPacjentMDIApplication */
  public JPacjentMDIApplication() {  
    System.out.println(" ...Creation form JPacjentMDIApplication");
    SplashJFrame sframe = null;       
    sframe = new SplashJFrame();
    sframe.setVisible(true);
    System.out.println(" ...form SplashJFrame created");
    // ...
    setClient( false );
    try {      
      setUpLookAndFeel();
  ...
  private void rapMenuItemAction() {
    ...
    if ( wybDialog.getReturnStatus() == RET_OK ) {
      ...
      if ( przyjecie != null ) {
        ...
        try {
          String str;
          str = Utilities.headWithTitle("Przyjêcie pacjenta");
        ...
        try {
          String str;
          str = Utilities.headWithTitle("Przyjêcia pacjentów");
  ...
  public final void addNowePrzyjecie( boolean first ) {    
    updateComponents();
